...
# Basic settings
AGENTS_NUM = 50  # Number of traders
...
LOAN_TYPE_DATE = [22, 44, 66]     # Loan duration (days)
LOAN_RATE = [0.027, 0.03, 0.033]  # Loan interest rates
...
# Financial reports
SEASONAL_DAYS = 66                # Length of one quarter
SEASON_REPORT_DAYS = [12, 78, 144, 210]  # Financial report release days
...
EVENT_1_LOAN_RATE = [0.024, 0.027, 0.030]  # Interest rates after the reserve requirement ratio cut
